<div class="col-md-9 order-2 results">
					...
					<div class="col-sm-6 col-lg-4 mb-4">
						...
						<div class="block-4 text-center border">
							<figure class="block-4-image">
								...
								<a href="shop-single.php?product_id=<?php echo $product_array["product_id"]; ?>"><img
										src="admin/product_images/<?php echo $product_array["product_image"]; ?>" width="200"
										height="200"></a>
							</figure>
							<div class="block-4-text p-4">
								<h3><a
										href="shop-single.php?product_id=<?php echo $product_array["product_id"]; ?>"><?php echo $product_array["product_name"]; ?></a>
								</h3>
	...
	<div class="row">
		<div class="col-md-12 text-center pagination">
			<ul class="pagination">
				<li><a
						href="?pageno=1<?php echo "&query=" . $search_query . "&category=" . urlencode($category_names) ?>">First</a>
				</li>
				<li class="<?php if ($pageno <= 1) {
					...
					<a
						href="<?php if ($pageno <= 1) {
							...
							echo "?pageno=" . ($pageno - 1) . "&query=" . $search_query . "&category=" . urlencode($category_names);
						} ?>">Prev</a>
				</li>
				...
				<li><a
						href="?pageno=<?php echo $total_pages . "&query=" . $search_query . "&category=" . urlencode($category_names); ?>">Last</a>
				</li>
			</ul>
		</div>
	</div>
