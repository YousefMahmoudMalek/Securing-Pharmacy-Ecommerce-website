	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="795" border="2" bgcolor="#187eae">
			...
			<tr>
				...
				<td><textarea name="product_description" cols="20"
						rows="10"><?php echo $product_description; ?></textarea></td>
			</tr>

			<tr>
				<td align="right"><b>Product Image:</b></td>
				<td><input type="file" name="product_image" /><img src="product_images/<?php echo $product_image; ?>"
			...
			<tr>
				...
				<td><input type="text" name="product_characteristic" size="50"
						value="<?php echo $product_characteristic; ?>" /></td>
			</tr>
