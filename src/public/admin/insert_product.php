		...
		<form action="" method="post" enctype="multipart/form-data">
			<table align="center" border="2px solid black" bgcolor="#187EAE">
				...
				<tr>
					...
					<td><textarea class="form-control border-0" name="product_description" cols="20"
							rows="10"></textarea></td>
				</tr>
				...
				<tr>
					<td align="center" colspan="8"><input class="btn btn-sm btn-primary" type="submit"
							name="insert_post" value="Insert Product"></td>
				</tr>
