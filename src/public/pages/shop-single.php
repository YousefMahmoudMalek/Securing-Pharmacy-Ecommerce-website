    ...
    <div class="bg-light py-3">
      <div class="container">
		...
		<?Php
			...
			?>
			<div class="col-md-12 mb-0"><a href="index.php?page=home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><?php echo $product_array['product_name']; ?></strong></div>
