...
<html lang="en">
  ...
  <div class="site-wrap">
            ...
            <div class="text-right col-6 col-md-4 order-3 order-md-3">
              <div class="site-top-icons">
                <ul>
                  ...
                  <li><a href="index.php?page=cart" class="site-cart"><span class="icon glyphicon glyphicon-shopping-cart"></span>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?page=home">Home</a> <span class="mx-2 mb-0">/</span> <a href="index.php?page=cart">Cart</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Checkout</strong></div>
        </div>
      </div>
    </div>
