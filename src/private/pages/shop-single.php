    ...
    <div class="bg-light py-3">
      <div class="container">
          ...
          if (mysqli_num_rows($sql)) {
            while ($product_array = mysqli_fetch_array($sql)) {
              ...
              <div class="col-md-12 mb-0"><a href="index.php?page=home">Home</a> <span class="mx-2 mb-0">/</span> <strong
                  class="text-black"><?php echo $product_array['product_name']; ?></strong></div>
                    ...
                    <div class="input-group mb-3" style="max-width: 120px;">
                      <div class="input-group-prepend">
                        <button type="button" class="btn btn-outline-primary js-btn-minus" data-quantity="minus"
                          data-field="quantity">&minus;</button>
                      </div>
                      ...
                      <div class="input-group-append">
                        <button class="btn btn-outline-primary js-btn-plus" data-quantity="plus" type="button"
                          data-field="quantity">&plus;</button>
                      </div>
        ...
        img.href = "cart.php?product_id=<?php echo $product_array["product_id"]; ?>&quantity=" +product_quantity;
                  ...
                  <p><button type="submit" id="pass-url" onclick="geturl()" class="buy-now btn btn-sm btn-primary">Add To
                      Cart</button></p>
                </div>
            </div>
            </form>
