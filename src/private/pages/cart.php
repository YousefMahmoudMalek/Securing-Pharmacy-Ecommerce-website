...
<body>
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.php?page=home" class="js-logo-clone">DrugsDirect</a>
              </div>
            </div>
            ...
            <div class="text-right col-6 col-md-4 order-3 order-md-3">
              <div class="site-top-icons">
                <ul>
                  <li><a href="index.php?page=signup"><span class="icon glyphicon glyphicon-user"></span></a></li>
                  <li><a href="index.php?page=cart" class="site-cart"><span
                        class="icon glyphicon glyphicon-shopping-cart"></span>
                  <li><a href="index.php?page=logout"><span class="glyphicon glyphicon-log-out"></span></a></li>
                  </a>
                  </li>
                </ul>
              </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php?page=home">Home</a> <span class="mx-2 mb-0">/</span> <strong
                      ...
                      while ($product_array = mysqli_fetch_array($sql)) {
                        ...
                        <tr>
                          <td class="product-thumbnail">
                            <img src="admin/product_images/<?php echo $product_array['product_image']; ?>" alt="Image"
                            ...
                            <div class="product-thumbnail">
                              <div class="input-group mb-3" style="max-width: 120px;">
                                <div class="input-group-prepend">
                                  <button type="button" class="btn btn-outline-primary js-btn-minus" data-quantity="minus"
                                    data-field="<?php echo $product_array["product_id"]; ?>">&minus;</button>
                                </div>
                                <input class="form-control text-center"
                                  name="quantity-<?php echo $product_array["product_id"]; ?>" value=<?php echo $product_array["quantity"]; ?> placeholder="">
                                <input type="hidden" name="product_count-<?php echo $product_array["product_id"]; ?>"
                                  value="<?php echo $product_array["product_count"]; ?>" />
                                <input type="hidden" name="product_id-<?php echo $product_array["product_id"]; ?>"
                                  value="<?php echo $product_array["product_id"]; ?>" />
                                <div class="input-group-append">
                                  <button class="btn btn-outline-primary js-btn-plus" data-quantity="plus" type="button"
                                    data-field="<?php echo $product_array["product_id"]; ?>">&plus;</button>
                                </div>
                              </div>
                          ...
                          <td>
                            <?php echo "$";
                            echo $product_array["quantity"] * $product_array['product_cost'];
                            $cart_total += $product_array["quantity"] * $product_array['product_cost'] ?>
                          </td>
                          <td><a href="#" class="btn btn-primary btn-sm"
                              onClick="removeProduct(<?php echo $product_array["product_id"] ?>)">X</a></td>
                        </tr>
                        <?php
                      }
                    }
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="row mb-5">
                ...
                <div class="col-md-6">
                  <button class="btn btn-outline-primary btn-sm btn-block" onclick="window.location='shop.php'">Continue
                    Shopping</button>
                </div>
              </div>
            </div>
