...
<body>
	...
	<div class="site-wrap">
					...
					<div class="row align-items-center">
						...
						<div class="text-right col-6 col-md-4 order-3 order-md-3">
							<div class="site-top-icons">
								<ul>
									<li><a href="index.php?page=signup"><span
												class="icon glyphicon glyphicon-user"></span></a></li>
									<li><a href="index.php?page=cart" class="site-cart"><span
												class="icon glyphicon glyphicon-shopping-cart"></span>
									<li><a href="index.php?page=logout"><span
			...
			<nav class="site-navigation text-md-center" role="navigation">
				<div class="container">
					<ul class="site-menu">
						...
						<li class="active"><a href="index.php?page=shop">Shop</a></li>
					</ul>
				</div>
			</nav>
		</header>
		...
		<div class="bg-light py-3">
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0"><a href="index.php?page=home">Home</a> <span class="mx-2 mb-0">/</span>
						<a href="index.php?page=cart">Cart</a> <span class="mx-2 mb-0">/</span> <strong
									...
									<div class="p-3 p-lg-5 border">
										<form id="coupon">
											...
											<div class="input-group w-75">
												...
												<button class="btn btn-primary btn-sm" id="apply_button" type="button"
													onclick="validate_coupon()">Apply</button> &nbsp;
												<button class="btn btn-primary btn-sm" id="remove_button" type="button"
													onclick="remove_coupon()">Remove</button>
											</div>
									...
									<div class="p-3 p-lg-5 border">
										<table class="table site-block-order-table mb-5">
											...
											<tbody>
												...
												if (mysqli_num_rows($sql)) {
													while ($product_array = mysqli_fetch_array($sql)) {
														...
														<tr>
															<td><?php echo $product_array['product_name']; ?> <strong
																	class="mx-2">x</strong>
																<?php echo $product_array['quantity']; ?></td>

															<?php
															$total_cost += $product_array['product_cost'] * $product_array['quantity'];
															?>

															<td>$<?php echo $product_array['product_cost'] * $product_array['quantity']; ?>.00
															</td>
														</tr>
														<?php
													}
											...
											<tr>
												...
												if (isset($_SESSION["coupon_cost"])) {
													...
													<td id="discount" class="text-black font-weight-bold">
														<strong>$<?php echo $total_cost - $_SESSION["coupon_cost"] ?></strong>
													</td>
													<?php
												} else {
													?>
													<td id="discount" class="text-black font-weight-bold">
														<strong>$<?php echo $total_cost ?></strong></td>
													<?php
												}
												?>
											</tr>
										...
										<div class="form-group">
											<button onclick="place_order()"
												class="btn btn-primary btn-lg py-3 btn-block">Place Order</button>
